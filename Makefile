...
delivery-claim-smoke: build
	scripts/delivery-claim-concurrency-smoke.sh
...
rollout-vm-lab-sync:
	...
	rsync -e "$(ROLLOUT_VM_LAB_SSH)" -a docs/labs.md $(ROLLOUT_VM_LAB_HOST):~/jetmon-rollout-tools/docs/
