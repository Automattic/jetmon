...
func openAPIComponentTypes() map[string]reflect.Type {
	return map[string]reflect.Type{
		...
		"RolloutCapabilitiesResponse": reflect.TypeOf(rolloutCapabilitiesResponse{}),
		"RolloutSessionRequest":       reflect.TypeOf(rolloutSessionRequest{}),
		"RolloutSessionResponse":      reflect.TypeOf(rolloutSessionResponse{}),
		"RolloutRangeRequest":         reflect.TypeOf(rolloutRangeRequest{}),
		"RolloutJobResponse":          reflect.TypeOf(rolloutJobResponse{}),
