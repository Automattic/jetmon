...
func apiRoutes() []routeDef {
	return []routeDef{
		...
		},
		{
			...
			Summary:        "Return the current Monitor dashboard state snapshot",
			Tags:           []string{"Dashboard"},
			Scope:          scopeRead,
			SuccessStatus:  http.StatusOK,
			ResponseSchema: "DashboardState",
			Handler:        (*Server).handleDashboardState,
		},
		{
			Method:         http.MethodGet,
			Path:           "/api/v1/dashboard/health",
			OperationID:    "getDashboardHealth",
			Summary:        "Return the current Monitor dependency health snapshot",
			Tags:           []string{"Dashboard"},
			Scope:          scopeRead,
			SuccessStatus:  http.StatusOK,
			ResponseSchema: "DashboardHealth",
			Handler:        (*Server).handleDashboardHealth,
		},
		{
			Method:         http.MethodGet,
			Path:           "/api/v1/dashboard/host",
			OperationID:    "getDashboardHost",
			Summary:        "Return the combined host dashboard snapshot",
			Tags:           []string{"Dashboard"},
			Scope:          scopeRead,
			SuccessStatus:  http.StatusOK,
			ResponseSchema: "DashboardHostSnapshot",
			Handler:        (*Server).handleDashboardHost,
		},
		{
			Method:         http.MethodGet,
			Path:           "/api/v1/dashboard/fleet",
			OperationID:    "getDashboardFleet",
			Summary:        "Return the fleet dashboard snapshot",
			Tags:           []string{"Dashboard"},
			Scope:          scopeRead,
			SuccessStatus:  http.StatusOK,
			ResponseSchema: "DashboardFleetSnapshot",
			Handler:        (*Server).handleDashboardFleet,
		},
		{
			Method:         http.MethodGet,
