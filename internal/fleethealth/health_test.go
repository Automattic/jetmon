...
func TestListSnapshots(t *testing.T) {
	...
	if got.RuntimeGoroutines != 41 || got.RuntimeGoroutinesRunnable != 2 || got.RuntimeGoroutinesRunning != 3 || got.RuntimeGoroutinesWaiting != 35 || got.RuntimeGoroutinesNotInGo != 1 || got.RuntimeGoroutinesCreated != 412 || got.RuntimeThreads != 7 {
		t.Fatalf("runtime fields = %+v, want populated scheduler metrics", got)
	}
