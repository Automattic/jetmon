...
function updateStats() {
	try {
		...
		spsFile.once( 'open', function( fd ) {
			spsFile.write( 'sites per second: ' + localSitesCount + '\n' );
			spsFile.end();
		});
		 ...
		 */
		statsdClient.increment( 'stats.sites.sps.count', localSitesCount );
		...
		statsdClient.increment( 'stats.sites.total.count', localGCountSuccess );
