...
var statsdClient = new StatsD( {
	...
	port: 8125,
	globalize: true,
	prefix: 'com.jetpack.jetmon.'+_os.hostname()+'.',
...
function logStatEntryToJetmon(name, value) {

}
function sendPeriodicStatsToStatsD() {

}

setInterval(sendPeriodicStatsToStatsD, 1000);
