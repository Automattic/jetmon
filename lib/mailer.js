...
var mailer = {
				...
				function( userID ) {
					...
					user.getUserObject( userID,
										function( userObject ) {
											...
											var mailOptions = mailer.getEmailData( userObject, templateKey );
	...
	getEmailData : function ( userObject, templateKey ) {
	...
	getEmailFieldData : function ( server, userObject ) {
		...
		return {
			...
			admin_url     : server.monitor_url + '/wp-admin/admin.php?page=jetpack#monitor',
