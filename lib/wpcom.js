...
var wpcom = {
	notifyStatusChange : function( serverObject, callBack ) {
		console.log('Notify Status Change: ' + serverObject.monitor_url + ' status is ' + serverObject.site_status);
		try {
			var o_request                = {};
			...
			db_mysql.updateSite( o_request.blog_id, o_request.monitor_url, o_request.status_id );
